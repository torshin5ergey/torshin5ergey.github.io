/* 
Conways generations b1s0g8 rule (acid dj)
Written by Sergey Torshin @torshin5ergey
*/

function setup() {
  CANVAS_W = 603; // 603 Canvas width (px)
  CANVAS_H = 1072; // 1072 Canvas height (px)

  WIDTH = 153; // 153 CA field width
  HEIGHT = 272; // 272 CA field height
// Single cell size (px)
...
function getCellNewValue(array, x, y, count) {
  if (count === 1 || (array[x][y] === generations && count === 0)) {
