...
tabs.forEach(tab => {
    tab.addEventListener("click", (event) => {
        ...
        if (sketchId === "random-mono") {
            captionTopLeft.textContent = "conways b1s0g8 random mono";
            loadScript("sketch-random-mono.js");
        } else if (sketchId === "random-color") {
            captionTopLeft.textContent = "conways b1s0g8 random color";
            loadScript("sketch-random-color.js");
        } else if (sketchId === "acid-dj") {
            captionTopLeft.textContent = "conways b1s0g8 acid dj";
            loadScript("sketch-acid-dj.js");
        }
        // Update description
