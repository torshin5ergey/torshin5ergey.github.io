...
const CANVAS_W = 603; // Canvas width (px) 603
const CANVAS_H = 1072; // Canvas height (px) 1072

const WIDTH = 153; // CA field width 153 27
const HEIGHT = 272; // CA field height 272 48
...
function setup() {
    ...
    //console.log(originalLine, cells[0])
    drawCellsField(cells);
}

function draw() {
    //drawCellsField(cells);
    // Loop line with original zeros
